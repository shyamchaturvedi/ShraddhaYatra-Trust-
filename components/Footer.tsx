...
const Footer: React.FC<FooterProps> = ({ logoUrl }) => {
    ...
    const FacebookIcon = () => <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path></svg>;
        ...
        <footer className="bg-amber-100 border-t border-amber-200">
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                <a href="#" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    <img src={logoUrl || '/logo.png'} alt="Shraddha Yatra Trust Logo" className="h-20 w-auto" />
                </a>
                <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    © {new Date().getFullYear()} Shraddha Yatra Trust —
                    <a href="https://twitter.com/" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@shraddhayatra</a>
                </p>
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <a className="text-gray-500 hover:text-orange-600 cursor-pointer"><FacebookIcon /></a>
                    <a className="ml-3 text-gray-500 hover:text-orange-600 cursor-pointer"><TwitterIcon /></a>
                    <a className="ml-3 text-gray-500 hover:text-orange-600 cursor-pointer"><InstagramIcon /></a>
                </span>
            </div>
        </footer>
    );
